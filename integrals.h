...
inline double fac_dalpha_overlap(const integrator & Integrator, const size_t n, const size_t m, const size_t k) {
	return Integrator.fac_dintegral_st(n, m+1, k);
}
...
inline double fac_dalpha_nuclear(const integrator & Integrator, const size_t n, const size_t m, const size_t k) {
        return Integrator.fac_dintegral_plain(n+1, m+1, k);
}
...
inline double fac_dalpha_kinetic(const integrator & Integrator, const size_t n, const size_t m, const size_t k) {
        return Integrator.fac_dintegral_st(n, m-1, k);
}
...
inline double fac_dalpha_repulsion(const integrator & Integrator, const size_t n, const size_t m, const size_t k) {
        return Integrator.fac_dintegral_st(n, m, k);
}
